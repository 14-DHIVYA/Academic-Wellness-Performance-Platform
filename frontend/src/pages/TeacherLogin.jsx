...
import { Lock, ArrowRight, GraduationCap, Mail } from "lucide-react";
...
const TeacherLogin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://academic-wellness-performance-platform-3.onrender.com/api/auth/login", {
        email,
        password,
      });
  ...
  return (
    <div className="min-h-screen flex bg-white">
      {/* Left Side - Visual */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center p-12 bg-violet-900">
        ...
        <div className="relative z-10 text-white max-w-lg text-center">
          ...
          <h1 className="text-5xl font-bold mb-6 leading-tight">Educator Portal</h1>
